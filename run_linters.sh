...
echo - e "\nRUN cppcheck"
check_log "cppcheck src --std=c++14 --enable=all --inconclusive --error-exitcode=1 -I src/ --suppress=missingIncludeSystem --suppress=unusedFunction --suppress=functionStatic --suppress=uninitMemberVar --suppress=unmatchedSuppression --suppress=virtualCallInConstructor --suppress=missingReturn --suppress=initializerList" "\(information\)"
